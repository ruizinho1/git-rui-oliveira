...
$this->title = 'Detalhes da Notícia 4';
?>
<style>
    body {
...
<div class="site-news4">
    <h1>Russell: Mercedes se saindo bem com motor de F1 de 2026</h1>
    <div class="images">
        <img src="<?= Url::to('@web/imagens/news4.jpg') ?>" alt="Imagem 1" >
        <img src="<?= Url::to('@web/imagens/news4_4.jpg') ?>" alt="Imagem 2" >
    </div>
    ...
    <p><?= \yii\helpers\Html::a('Voltar', ['site/index'], ['class' => 'btn btn-primary']) ?></p> <!-- Alterado a classe do botão para btn-back -->
</div>
